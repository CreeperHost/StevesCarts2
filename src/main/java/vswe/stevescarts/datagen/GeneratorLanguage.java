...
public class GeneratorLanguage extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("gui.stevescarts.transferItems.singular", "Transfer a maximum of %1$s item");
        add("gui.stevescarts.transferItems.plural", "Transfer a maximum of %1$s items");
        add("gui.stevescarts.transferStacks.singular", "Transfer a maximum of %1$s stack");
        add("gui.stevescarts.transferStacks.plural", "Transfer a maximum of %1$s stacks");
        ...
        add("gui.stevescarts.transferBuckets", "Transfer a maximum of %1$s");
        ...
        add("gui.stevescarts.sideName", "%1$s side");
        ...
        add("gui.stevescarts.sideToolTip", "Side: %1$s");
        ...
        addPlural("info.stevescarts.moduleGroupEngine", "Engine", "Engines");
        addPlural("info.stevescarts.moduleGroupDrill", "Drill", "Drills");
        addPlural("info.stevescarts.moduleGroupFarmer", "Farmer", "Farmers");
        addPlural("info.stevescarts.moduleGroupCutter", "Wood Cutter", "Wood Cutters");
        addPlural("info.stevescarts.moduleGroupTank", "Tank", "Tanks");
        addPlural("info.stevescarts.moduleGroupEntity", "Entity Detector", "Entity Detectors");
        addPlural("info.stevescarts.moduleGroupShooter", "Shooter", "Shooters");
        addPlural("info.stevescarts.moduleGroupTool", "Tool", "Tools");
        addPlural("info.stevescarts.moduleGroupToolShooter", "Tool or Shooter", "Tools or Shooters");
        ...
        add("info.stevescarts.shiftForMore", "Press <%1$s> for more info");
        addPlural("info.stevescarts.occupiedSides", "Will occupy the %1$s side", "Will occupy the %1$s sides");
        ...
        add("info.stevescarts.complexityOverloadError", "%1$s is too complex for this hull.");
        add("info.stevescarts.missingParentError", "%1$s requires %2$s to work!");
        add("info.stevescarts.presentNemesisError", "%1$s won't work with %2$s");
        add("info.stevescarts.presentDuplicateError", "%1$s is not allowed to be added twice.");
        add("info.stevescarts.sideClashError", "%1$s and %2$s will clash at the %3$s");
        add("info.stevescarts.toolUnbreakable", "Unbreakable");
        add("info.stevescarts.toolDurability", "Durability: %1$s%%");
        add("info.stevescarts.modularCapacity", "Modular capacity: %1$s");
        add("info.stevescarts.complexityCap", "Module complexity cap: %1$s");
        add("info.stevescarts.maxEngineCount", "Max engines count: %1$s");
        add("info.stevescarts.maxAddonCount", "Max Addon count: %1$s");
        ...
        add("info.stevescarts.effectFuelCapacity", "Fuel capacity %1$s.");
        add("info.stevescarts.effectFuelCost", "Fuel cost %1$s%%.");
        add("info.stevescarts.effectInputChest", "Input Chest with %1$s slots.");
        add("info.stevescarts.effectManagerBridge", "Connects the Assembler with a Manager.");
        addPlural("info.stevescarts.effectGenerator", "Generate %1$s unit of power per minute.", "Generate %1$s units of power per minute.");
        ...
        addPlural("info.stevescarts.effectTimeFlat", "Module assembling time %1$s second.", "Module assembling time %1$s seconds.");
        addPlural("info.stevescarts.effectTimeFlatCart", "Cart assembling time %1$s second.", "Cart assembling time %1$s seconds.");
        addPlural("info.stevescarts.effectTimeFlatRemove", "Module disassembling time %1$s second.", "Module disassembling time %1$s seconds.");
        add("info.stevescarts.effectTransposer", "Can pick up carts for modifying");
        add("info.stevescarts.effectEfficiency", "Assembling efficiency %1$s%%.");
        ...
        add("modules.addons.stevescarts.intelligenceCurrent.enabled", "Currently: Enabled");
        add("modules.addons.stevescarts.intelligenceCurrent.disabled", "Currently: Disabled");
        ...
        add("modules.addons.stevescarts.invisibilityToggle.activate", "Activate invisibility core");
        add("modules.addons.stevescarts.invisibilityToggle.deactivate", "Deactivate invisibility core");
        ...
        add("modules.addons.stevescarts.informationProviderMessageDistance", "Distance: %1$sm");
        add("modules.addons.stevescarts.informationProviderLabelPosition", "Position");
        add("modules.addons.stevescarts.informationProviderMessagePosition", "X: %1$s Y: %2$s Z: %3$s");
        ...
        add("modules.addons.stevescarts.recipeChangeLimit.increase", "Increase items to keep stocked.");
        add("modules.addons.stevescarts.recipeChangeLimit.decrease", "Decrease items to keep stocked.");
        ...
        add("modules.engines.stevescarts.enginePriorityMessage.0", "High priority");
        add("modules.engines.stevescarts.enginePriorityMessage.1", "Medium priority");
        add("modules.engines.stevescarts.enginePriorityMessage.2", "Low priority");
        add("modules.tanks.stevescarts.creativeTankMode", "Current creative mode: %1$s%2$s");
        add("modules.tanks.stevescarts.creativeTankMode.0", "Normal");
        add("modules.tanks.stevescarts.creativeTankMode.1", "Always full");
        add("modules.tanks.stevescarts.creativeTankMode.2", "Always empty");
        add("modules.tanks.stevescarts.creativeTankMode.3", "Always half");
        ...
        add("modules.tools.stevescarts.toolRepairInstruction", "Repair this tool with %1$s");
        ...
        add("modules.tools.stevescarts.drillToggle.enable", "Enable drill");
        add("modules.tools.stevescarts.drillToggle.disable", "Disable drill");
        ...
        add("modules.attachments.stevescarts.controlSystemDistanceUnits.0", "m");
        add("modules.attachments.stevescarts.controlSystemDistanceUnits.1", "km");
        add("modules.attachments.stevescarts.controlSystemDistanceUnits.2", "Mm");
        add("modules.attachments.stevescarts.controlSystemDistanceUnits.3", "Gm");
        add("modules.attachments.stevescarts.controlSystemDistanceUnits.4", "Tm");
        add("modules.attachments.stevescarts.controlSystemDistanceUnits.5", "Pm");
        ...
        add("modules.attachments.stevescarts.cageAutoPickUp.activate", "Activate auto pick up");
        add("modules.attachments.stevescarts.cageAutoPickUp.deactivate", "Deactivate auto pick up");
        add("modules.attachments.stevescarts.cagePickUp.grab", "Grab nearby creature");
        add("modules.attachments.stevescarts.cagePickUp.release", "Release caged creature");
        add("modules.attachments.stevescarts.cakeServerTitle", "Cake Server");
        add("modules.attachments.stevescarts.cakesLabel", "Cakes: %1$s / %2$s");
        add("modules.attachments.stevescarts.slicesLabel", "Slices: %1$s / %2$s");
        ...
        add("modules.attachments.stevescarts.experienceLevel", "Experience level: %1$s / %2$s");
        ...
        add("modules.attachments.stevescarts.experiencePlayerLevel", "Your current level is %1$s");
        ...
        add("modules.attachments.stevescarts.noteAdd", "Add note to track #%1$s");
        add("modules.attachments.stevescarts.noteRemove", "Remove rightmost note from track #%1$s");
        add("modules.attachments.stevescarts.noteActivateInstrument", "Activate %1$s");
        add("modules.attachments.stevescarts.noteDeactivateInstrument", "Remove NoteBlock setting");
        add("modules.attachments.stevescarts.noteDelay", "Change delay. Current Delay: %1$s");
        add("modules.attachments.stevescarts.noteVolume.0", "Track volume: Muted");
        add("modules.attachments.stevescarts.noteVolume.1", "Track volume: Low");
        add("modules.attachments.stevescarts.noteVolume.2", "Track volume: Medium");
        add("modules.attachments.stevescarts.noteVolume.3", "Track volume: High");
        add("modules.attachments.stevescarts.seatStateMessage.0", "This cart is occupied");
        add("modules.attachments.stevescarts.seatStateMessage.1", "Mount cart");
        add("modules.attachments.stevescarts.seatStateMessage.2", "Dismount cart");
        ...
        add("arcade.stevescarts.highScore", "High Score: %1$s");
        add("arcade.stevescarts.score", "Score: %1$s");
        ...
        add("arcade.stevescarts.creepersLeft", "Creepers left:  %1$s");
        add("arcade.stevescarts.creeperTime", "Time spent: %1$ss");
        add("arcade.stevescarts.instructionChangeMap", "Change map size");
        add("arcade.stevescarts.creeperCurrentMap", "Current %1$s");
        add("arcade.stevescarts.creeperHighScores", "High Scores");
        add("arcade.stevescarts.creeperHighScore", "%1$s: %2$ss");
        add("arcade.stevescarts.mobStacker", "Mob Stacker");
        add("arcade.stevescarts.stackerRemovedLines", "Removed lines: %1$s");
        add("arcade.stevescarts.stackerRemovedLinesCombo.0", "Removed single lines: %1$s");
        add("arcade.stevescarts.stackerRemovedLinesCombo.1", "Removed double lines: %1$s");
        add("arcade.stevescarts.stackerRemovedLinesCombo.2", "Removed triple lines: %1$s");
        add("arcade.stevescarts.stackerRemovedLinesCombo.3", "Removed quadruple lines: %1$s");
    ...
    private void addPlural(String key, String singular, String plural) {
        add(key + ".singular", singular);
