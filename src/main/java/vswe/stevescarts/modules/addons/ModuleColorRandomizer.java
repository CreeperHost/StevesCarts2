...
public class ModuleColorRandomizer extends ModuleAddon {
    ...
    public void drawBackground(GuiGraphicsExtractor GuiGraphicsExtractor, GuiMinecart gui, final int x, final int y) {
        ...
        drawImage(GuiGraphicsExtractor, texture, gui, 50, 20, 0, 16, 28, 28);
        if (inRect(x, y, button)) {
            drawImage(GuiGraphicsExtractor, texture, gui, 10, 26, 32, 0, 16, 16);
        } else {
            drawImage(GuiGraphicsExtractor, texture, gui, 10, 26, 16, 0, 16, 16);
        }
        drawImage(GuiGraphicsExtractor, texture, gui, 10, 26, 0, 0, 16, 16);
    }
