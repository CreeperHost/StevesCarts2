...
public abstract class ModuleCoalBase extends ModuleEngine {
        ...
        if (getFuelLevel() <= consumption) {
            ...
            while (i < getInventorySize()) {
                ...
                if (getFuelLevel() > consumption) {
                    ...
                    ItemStack remainder = getStack(i).getCraftingRemainder() != null ? getStack(i).getCraftingRemainder().create() : ItemStack.EMPTY;
    ...
    public void drawForeground(GuiGraphicsExtractor GuiGraphicsExtractor, GuiMinecart gui) {
        ...
        drawString(GuiGraphicsExtractor, gui, strfuel, 8, 48, 4210752);
    }
