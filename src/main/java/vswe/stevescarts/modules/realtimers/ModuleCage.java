...
public class ModuleCage extends ModuleBase implements IActivatorModule {
    private final int[] autoRect;
    private final int[] manualRect;
    ...
    public void drawBackground(GuiGraphicsExtractor GuiGraphicsExtractor, final GuiMinecart gui, final int x, final int y) {
        ...
        drawButton(GuiGraphicsExtractor, texture, gui, x, y, autoRect, disablePickup ? 2 : 3);
        drawButton(GuiGraphicsExtractor, texture, gui, x, y, manualRect, isCageEmpty() ? 0 : 1);
    }
