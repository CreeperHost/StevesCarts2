...
//    }
    ...
    private void drawContent(GuiGraphicsExtractor GuiGraphicsExtractor, Identifier texture, GuiMinecart gui, final int x, final int y, final int id) {
        ...
        drawImage(GuiGraphicsExtractor, texture, gui, content, 4 + content[2] * (id + 1), content[4] - content[3]);
    }
    ...
    public void drawBackground(GuiGraphicsExtractor GuiGraphicsExtractor, GuiMinecart gui, final int x, final int y) {
        ...
        for (int i = 0; i < 3; ++i) {
            drawContent(GuiGraphicsExtractor, texture, gui, x, y, i);
        }
        drawImage(GuiGraphicsExtractor, texture, gui, getContainerRect(), 0, inRect(x, y, getContainerRect()) ? 65 : 0);
    }
