...
public class Cart {
    ...
    public void render(GuiGraphicsExtractor GuiGraphicsExtractor, Identifier texture, ArcadeTracks game, final GuiMinecart gui, final int tick) {
        if (!enabled) {
            return;
        }
        ...
        final int w = 12;
        final int h = 12;
        game.drawImageInArea(GuiGraphicsExtractor, texture, gui, x, y, u, v, w, h);
    }
