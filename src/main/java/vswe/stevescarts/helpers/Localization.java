...
public final class Localization
{
    ...
    {
        ENGINE_GROUP("moduleGroupEngine"), DRILL_GROUP("moduleGroupDrill"), FARMER_GROUP("moduleGroupFarmer"), CUTTER_GROUP("moduleGroupCutter"), TANK_GROUP("moduleGroupTank"), ENTITY_GROUP("moduleGroupEntity"), SHOOTER_GROUP("moduleGroupShooter"), TOOL_GROUP("moduleGroupTool"), TOOL_OR_SHOOTER_GROUP("moduleGroupToolShooter"), HULL_CATEGORY("moduleCategoryHull"), ENGINE_CATEGORY("moduleCategoryEngine"), TOOL_CATEGORY("moduleCategoryTool"), STORAGE_CATEGORY("moduleCategoryStorage"), ADDON_CATEGORY("moduleCategoryAddon"), ATTACHMENT_CATEGORY("moduleCategoryAttachment"), PIG_MESSAGE("pigExtraMessage"), OCEAN_MESSAGE("oceanExtraMessage"), OPEN_TANK("openExtraMessage"), ALPHA_MESSAGE("alphaExtraMessage"), STORAGE_EMPTY("storageEmpty"), STORAGE_FULL("storageFull"), GIFT_STORAGE_FULL("giftStorageFull"), EGG_STORAGE_FULL("eggStorageFull"), MODULAR_COST("modularCost"), SIDE_NONE("cartSideNone"), SIDE_TOP("cartSideTop"), SIDE_CENTER("cartSideCenter"), SIDE_BOTTOM("cartSideBottom"), SIDE_BACK("cartSideBack"), SIDE_LEFT("cartSideLeft"), SIDE_RIGHT("cartSideRight"), SIDE_FRONT("cartSideFront"), OCCUPIED_SIDES("occupiedSides"), AND("sidesAnd"), SHIFT_FOR_MORE("shiftForMore"), NO_SIDES("noSides"), CONFLICT_HOWEVER("moduleConflictHowever"), CONFLICT_ALSO("moduleConflictAlso"), REQUIREMENT("moduleRequirement"), MODULE_COUNT_1("moduleCount1"), MODULE_COUNT_2("moduleCount2"), MODULE_COUNT_3("moduleCount3"), DUPLICATES("allowDuplicates"), TYPE("moduleType"), CAPACITY_ERROR("capacityOverloadError"), COMBINATION_ERROR("impossibleCombinationError"), COMPLEXITY_ERROR("complexityOverloadError"), PARENT_ERROR("missingParentError"), NEMESIS_ERROR("presentNemesisError"), DUPLICATE_ERROR("presentDuplicateError"), CLASH_ERROR("sideClashError"), TOOL_UNBREAKABLE("toolUnbreakable"), TOOL_DURABILITY("toolDurability"), MODULAR_CAPACITY("modularCapacity"), COMPLEXITY_CAP("complexityCap"), MAX_ENGINES("maxEngineCount"), MAX_ADDONS("maxAddonCount");
    ...
    public enum ARCADE
    {
        GHAST("ghastInvaders"), EXTRA_LIVES("ghastLives"), HIGH_SCORE("highScore"), SCORE("score"), INSTRUCTION_SHOOT("instructionShoot"), INSTRUCTION_LEFT("instructionLeft"), INSTRUCTION_RIGHT("instructionRight"), INSTRUCTION_RESTART("instructionRestart"), CREEPER("creeperSweeper"), MAP_1("creeperMapName1"), MAP_2("creeperMapName2"), MAP_3("creeperMapName3"), LEFT("creepersLeft"), TIME("creeperTime"), INSTRUCTION_CHANGE_MAP("instructionChangeMap"), MAP("creeperCurrentMap"), HIGH_SCORES("creeperHighScores"), HIGH_SCORE_ENTRY("creeperHighScore"), STACKER("mobStacker"), REMOVED_LINES("stackerRemovedLines"), REMOVED_LINES_COMBO("stackerRemovedLinesCombo"), INSTRUCTION_ROTATE("instructionRotate"), INSTRUCTION_DROP("instructionDrop"), OPERATOR("trackOperator"), SAVE_ERROR("operatorSaveError"), SAVE("operatorSave"), USER_MAPS("operatorUserCreatedMaps"), STORIES("operatorStories"), HELP("operatorHelp"), INSTRUCTION_SHAPE("instructionTrackShape"), INSTRUCTION_ROTATE_TRACK("instructionRotateTrack"), INSTRUCTION_FLIP_TRACK("instructionFlipTrack"), INSTRUCTION_DEFAULT_DIRECTION("instructionDefaultDirection"), INSTRUCTION_TRACK_TYPE("instructionTrackType"), INSTRUCTION_DELETE_TRACK("instructionDeleteTrack"), INSTRUCTION_COPY_TRACK("instructionCopyTrack"), INSTRUCTION_STEVE("instructionMoveSteve"), INSTRUCTION_MAP("instructionMoveMap"), INSTRUCTION_PLACE_TRACK("instructionPlaceTrack"), INSTRUCTION_DESELECT_TRACK("instructionDeselectTrack"), LEFT_MOUSE("leftMouseButton"), RIGHT_MOUSE("rightMouseButton"), BUTTON_START("buttonStart"), BUTTON_MENU("buttonMenu"), BUTTON_STOP("buttonStop"), BUTTON_NEXT("buttonNextLevel"), BUTTON_START_LEVEL("buttonStartLevel"), BUTTON_SELECT_STORY("buttonSelectStory"), BUTTON_SELECT_OTHER_STORY("buttonSelectStoryOther"), BUTTON_CREATE_LEVEL("buttonCreateLevel"), BUTTON_EDIT_LEVEL("buttonEditLevel"), BUTTON_REFRESH("buttonRefreshList"), BUTTON_SAVE("buttonSave"), BUTTON_SAVE_AS("buttonSaveAs"), BUTTON_CANCEL("buttonCancel"), MADNESS("forgecraftMadness");
    ...
    public static class STORIES
    {
        ...
        {
            MAP_EDITOR("mapEditor"), TITLE("title"), MISSION("mission"), START("start"), STOP("stop"), MAP("map"), TRACK_OPERATOR("trackOperator"), GOOD_JOB("goodJob"), CHANGE_JUNCTIONS("changeJunctions"), BLAST("blast"), STEEL("steel"), DETECTOR("detector"), OUT_OF_REACH("outOfReach"), OUT_OF_REACH_2("outOfReach2"), LONG_JOURNEY("longJourney"), END("end"), THANKS("thanks"), LEVEL_1("level1"), LEVEL_2("level2"), LEVEL_3("level3"), LEVEL_4("level4"), LEVEL_5("level5"), LEVEL_6("level6"), LEVEL_7("level7"), LEVEL_8("level8"), LEVEL_9("level9");
