...
public class ModelFrontTank extends ModelCartbase
{
    ...
    public static LayerDefinition getTexturedModelData()
    {
        ...
        for (int i = 0; i < 2; ++i) {
            modelPartData.addOrReplaceChild("side" + i, CubeListBuilder.create().texOffs(0, 15)
                    .addBox(-4.0f, -3.0f, -0.5f, 8, 6, 1), PartPose.offset(-14.0f, 0.0f, -6.5f + i * 13));
            modelPartData.addOrReplaceChild("topbot" + i, CubeListBuilder.create().texOffs(0, 0)
                    .addBox(-4.0f, -7.0f, -0.5f, 8, 14, 1), PartPose.offsetAndRotation(-14.0f, 3.5f - i * 7, 0.0f, 1.5707964f, 0.0F, 0.0F));
            modelPartData.addOrReplaceChild("frontback" + i, CubeListBuilder.create().texOffs(0, 22)
                    .addBox(-6.0f, -3.0f, -0.5f, 12, 6, 1), PartPose.offsetAndRotation(-17.5f + i * 7, 0.0f, 0.0f, 0.0F, 1.5707964f, 0.0F));
        }
