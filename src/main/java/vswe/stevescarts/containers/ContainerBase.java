...
{
    public ContainerBase(@Nullable ContainerType<?> p_i50105_1_, int p_i50105_2_)
    {
        super(p_i50105_1_, p_i50105_2_);
    }

    //Copied from QuantumStorage 1.17
    @Override
    ...
    public static boolean canStacksMerge(ItemStack stack1, ItemStack stack2)
    {
        ...
        if (!ItemStack.isSameIgnoreDurability(stack1, stack2)) return false;
        return true;
    }
